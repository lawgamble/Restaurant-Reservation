...
const hasRequiredProperties = hasValidProps("table_name", "capacity");

const hasRequiredUpdateProperties = hasValidProps("reservation_id");
...
module.exports = {
  ...
  update: [
    ...
    asyncErrorBoundaries(tableExists),
