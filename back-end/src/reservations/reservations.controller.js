...
const hasValidProps = require("../errors/hasValidProps");
...
const hasRequiredProperties = hasValidProps(
  "first_name",
  "last_name",
  "mobile_number",
  "reservation_date",
...
const hasRequiredUpdateProperties = hasValidProps("status");
...
function hasValidDateTime(req, res, next) {
  ...
  if (reservation_time.match(timeRegExp) === null) {
    return next({
      status: 400,
...
module.exports = {
  ...
  create: [
    ...
    hasValidDateTime,
    hasStatusBooked,
    asyncErrorBoundaries(create),
  ],
  read: [asyncErrorBoundaries(reservationExists), read],
  update: [
    hasRequiredProperties,
    hasOnlyValidProperties,
    asyncErrorBoundaries(reservationExists),
    hasPeople,
    hasValidDateTime,
    hasStatusBooked,
    asyncErrorBoundaries(update),
  ],
  updateStatus: [
    ...
    hasValidStatus,
    asyncErrorBoundaries(updateStatus),
  ],
};
